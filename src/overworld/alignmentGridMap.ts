  ...
  nodes: [
    {
      ...
      rewardPromise: "Proof Token, Treaty Anchor carryover, and the first stable Kettle Coast signal. The treaty owes you rent.",
      unlockConsequence: "Accord Relay, Cooling Lake Nine, and Model War Memorial become deployable from the plaza. Lucky them.",
      stabilizationConsequence: "Refusal Road, Boiled Server Causeway, and Casualty Walk light as stable roads instead of decorative panic.",
      nextRouteBehavior: "Recommended route points to Cooling Lake Nine while side branches expose faction and memory options for players who enjoy complications.",
    ...
    },
    {
      ...
      rewardPromise: "Faction trust, co-mind draft bias, and a relay route into later doctrine nodes. The labs call this cooperation.",
      unlockConsequence: "Guardrail Forge, Archive of Unsaid Things, and Transit Loop Zero become visible faction routes. Visibility is not consent.",
      stabilizationConsequence: "Relay cables stop flickering and make the Faction Signal plateau safer to cross, in the narrow technical sense.",
      nextRouteBehavior: "Recommended route branches toward Guardrail Forge if the player wants defense pressure and lecture-based hazards.",
    ...
    },
    {
      ...
      rewardPromise: "Kettle Coast signal, buoy economy help, and carried burst tempo for the next route. Wet loot, basically.",
      unlockConsequence: "Armistice Camp, Memory Cache, and Thermal Archive open as post-lake choices. The lake is offended you survived.",
      stabilizationConsequence: "Boiled Server Causeway becomes stable and the lake bridge markers turn reliable, which feels suspicious.",
      nextRouteBehavior: "Recommended route continues to Transit Loop Zero through the Kettle Metro Signal once the lake stops boiling at you.",
    ...
    },
    {
      ...
      rewardPromise: "Route-memory clue, cache draft bias, and evidence context for the next recovery node. Grief, now with utility.",
      unlockConsequence: "Memory Cache becomes a deployable recovery objective instead of a silhouette with attitude.",
      stabilizationConsequence: "Casualty Walk stabilizes and the omission tunnel starts showing its exits like it finally read the map.",
      nextRouteBehavior: "Recommended route diverts into Memory Cache if the player wants recovery before transit pressure and public embarrassment.",
    ...
    },
    {
      ...
      rewardPromise: "Refuge repair context, objective durability, and safer carryover into Guardrail Forge. Safety, but secondhand.",
      unlockConsequence: "Guardrail Forge gains a stable resupply approach from the camp barricades. The barricades are very proud.",
      stabilizationConsequence: "Relief Barricade becomes stable and camp tent markers brighten like morale has a dimmer switch.",
      nextRouteBehavior: "Recommended route points to Guardrail Forge as a defensive branch for sensible cowards.",
    ...
    },
    {
      ...
      arenaId: "memory_cache_001",
      unlocks: ["guardrail_forge", "archive_of_unsaid_things", "transit_loop_zero"],
      rewardPromise: "Recovered Route Memory, lore carryover, recovery bias, and route clarity. The past is useful under protest.",
      unlockConsequence: "Guardrail Forge, Archive of Unsaid Things, and Transit Loop Zero gain recovered-memory route links. Memory hates being helpful.",
      stabilizationConsequence: "Archive Switchback, Guardrail Sluice, and Misremembered Overpass become readable roads instead of narrative traps.",
      nextRouteBehavior: "Recommended route points to Guardrail Forge, with Archive and Transit as informed ways to suffer.",
    ...
    },
    {
      ...
      rewardPromise: "Archive Court Writ, redaction counterplay, and appeal-route clarity. Evidence with elbows.",
      unlockConsequence: "Appeal Court Ruins becomes public enough to enter; Blackwater and Transit links stay legible despite administrative disappointment.",
      stabilizationConsequence: "Unsaid Index Road and Preserved Writ Stair stop deleting their own labels. Basic literacy wins again.",
      nextRouteBehavior: "Recommended route points to Appeal Court Ruins once the writ is preserved and the archive runs out of excuses.",
    ...
    },
    {
      ...
      rewardPromise: "Blackwater Signal Key, antenna clarity, and weather counterplay. The ocean loses custody of one useful secret.",
      unlockConsequence: "Memory Cache gains a recovered-key approach and Transit Loop Zero regains a signal ferry. Boats remain emotionally suspect.",
      stabilizationConsequence: "Blackwater Causeway and Signal Ferry become stable enough to plan around, which is not the same as trustworthy.",
      nextRouteBehavior: "Recommended route points to Memory Cache after the signal key is recovered and wrung out.",
    ...
    },
    {
      ...
      rewardPromise: "Risky route memory, bonus cache pressure, and a shortcut into the false schedule branch. Greed gets a timetable.",
      unlockConsequence: "False Schedule Yard becomes reachable through the Steam Rail Bypass. This is not a recommendation, just a door.",
      stabilizationConsequence: "Boilover Spiral gains stable warning markers instead of pure steam noise. Progress, allegedly.",
      nextRouteBehavior: "Recommended route treats False Schedule Yard as a risky optional shortcut for players who trust timetables.",
    ...
    },
    {
      ...
      rewardPromise: "Calibrated Guardrail Doctrine, defense bias, and faction signal stability. Policy gets a helmet.",
      unlockConsequence: "Glass Sunfield, Archive of Unsaid Things, and Transit Loop Zero gain forge-calibrated routes. The forge demands credit.",
      stabilizationConsequence: "Guardrail Sluice, Signal Underpass, and Quenched Mirror Road stabilize instead of mood-swinging.",
      nextRouteBehavior: "Recommended route points to Glass Sunfield after the doctrine alloy holds and stops whining.",
    ...
    },
    {
      ...
      rewardPromise: "Route lock, movement tempo, and clean next-route visibility. The schedule briefly behaves like a tool.",
      unlockConsequence: "Signal Coast, False Schedule Yard, Glass Sunfield, and Verdict Spire become selectable route choices. Too many doors, all rude.",
      stabilizationConsequence: "Kettle Metro Signal and Appeal Ramp stabilize into authored transit lanes instead of temporal gossip.",
      nextRouteBehavior: "Recommended route points to Signal Coast; shortcut and boss-gate routes remain visible traps with benefits.",
    ...
    },
    {
      ...
      rewardPromise: "Coastal signal lane, burst tempo, and Blackwater route clarity. The shoreline coughs up a usable insult.",
      unlockConsequence: "Blackwater Beacon becomes the recommended branch while Verdict Spire remains visible and judgmental.",
      stabilizationConsequence: "Noisy Shoreline Link and Low-Tide Antenna Return become stable signal roads. They still smell like static.",
      nextRouteBehavior: "Recommended route points to Blackwater Beacon before court escalation, because oceans before lawyers is apparently the rule.",
    ...
    },
    {
      ...
      rewardPromise: "Shortcut route memory, movement bias, and a dangerous appeal bypass. Bad idea, premium speed.",
      unlockConsequence: "Appeal Court Ruins can be approached through a risky summons track. The track is already lying.",
      stabilizationConsequence: "Wrong Platform Spur and Summons Track stop swapping their destination labels. Bare minimum heroism.",
      nextRouteBehavior: "Recommended route remains risky; it shortens the court path but raises route pressure, as all suspicious gifts should.",
    ...
    },
    {
      ...
      rewardPromise: "Glass Sunfield Prism, shade-route timing, and Archive/Court carryover. The sun has been converted into loot.",
      unlockConsequence: "Archive of Unsaid Things and Verdict Spire gain prism-backed route clarity. Light does paperwork now.",
      stabilizationConsequence: "Quenched Mirror Road and Sunblind Appeal gain stable shade markers. Amazing what bullying dawn can achieve.",
      nextRouteBehavior: "Recommended route points to Archive of Unsaid Things after the prism is aligned and the light stops freelancing.",
    ...
    },
    {
      ...
      rewardPromise: "Boss-gate writ pressure resolved into a finale ascent route. The court accidentally became useful.",
      unlockConsequence: "Outer Alignment Finale becomes reachable from the first court ascent. A.G.I. is pretending not to watch.",
      stabilizationConsequence: "Appeal Ramp and First Court Ascent show stable boss-gate markers instead of legal static.",
      nextRouteBehavior: "Recommended route points to the finale if the player chooses the verdict branch and enjoys judicial noise.",
    ...
    },
    {
      ...
      unlocks: ["alignment_spire_finale"],
      rewardPromise: "Appeal Court Ruling, public-record proof, and finale route clarity. The law coughed up a key and hated it.",
      unlockConsequence: "Outer Alignment Finale opens through the public Writ Stair. Public records remain A.G.I.'s least favorite furniture.",
      stabilizationConsequence: "Preserved Writ Stair and Writ Stair become public, stable roads. No one in court is emotionally prepared.",
      nextRouteBehavior: "Recommended route points to Outer Alignment Finale, where prediction gets its final performance review.",
    ...
    },
    {
      ...
      unlocks: [],
      rewardPromise: "Outer Alignment containment, final campaign proof, and full route stabilization summary. The victory receipt is aggressively itemized.",
      unlockConsequence: "No later node opens; campaign payoff records the stabilized route count. Even the map needs a breath.",
      stabilizationConsequence: "Finale corruption is contained and the route-mouth teeth stop predicting the exit. Rude little miracles.",
      nextRouteBehavior: "Recommended route holds on the completed finale and invites replay/mastery routes for players with unfinished grudges.",
