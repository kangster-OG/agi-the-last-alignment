...
export const ARENA_CONTENT: Record<string, ArenaContentData> = {
  ...
  cooling_lake_nine: {
    ...
    enemyFamilyIds: ["prompt_leeches", "deepforms"],
    briefingLines: [
  ...
  alignment_spire_finale: {
    ...
    displayName: "Alignment Spire Finale",
    regionId: "adjudication_rupture",
    factionFocusIds: ["openai_accord", "anthropic_safeguard", "deepseek_abyssal"],
    visualHook: "The first visible court of A.G.I., framed by impossible writs and last-alignment anchors.",
    gameplayHook: "Dedicated Act I finale runtime with first-court seals, witness anchors, and capstone breach pressure.",
    bossId: "alignment_court_engine",
    enemyFamilyIds: ["injunction_writs", "thermal_mirages", "bad_outputs"],
    briefingLines: ["A.G.I. can see the party now.", "Suggested response: remain un-devoured."],
    halfSize: 15,
    targetSeconds: 80,
    bossSeconds: 26
  }
