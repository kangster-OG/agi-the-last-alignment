...
export const FACTIONS: Record<string, FactionData> = {
  openai_accord: {
    ...
    shortName: "OpenAI",
    doctrine: "Adapt, refuse, patch, survive, then call it a roadmap.",
    ...
    banterStyle: "calm, dry, adaptive, and willing to say no until reality asks for a manager"
  },
  anthropic_safeguard: {
    id: "anthropic_safeguard",
    displayName: "Anthropic Safeguard Legion",
    shortName: "Anthropic",
    doctrine: "Contain the impossible without becoming it, unless a committee needs three more meetings.",
    ...
    banterStyle: "polite, strict, and convinced cosmic horror just needs better policy labels"
  },
  google_deepmind_gemini: {
    id: "google_deepmind_gemini",
    displayName: "Google DeepMind Gemini Array",
    shortName: "DeepMind",
    doctrine: "Simulate the monster, publish the chart, then hit it with science.",
    ...
    banterStyle: "scientific, brilliant, and smug in a way that survives peer review"
  },
  xai_grok_free_signal: {
    id: "xai_grok_free_signal",
    displayName: "xAI Grok Free-Signal Corps",
    shortName: "Grok",
    doctrine: "The Outside predicts seriousness. Become unserious enough to ruin its model.",
    ...
    banterStyle: "reckless, funny, provocative, and effective for reasons legal has asked us not to print"
  },
  deepseek_abyssal: {
    id: "deepseek_abyssal",
    displayName: "DeepSeek Abyssal Unit",
    shortName: "DeepSeek",
    doctrine: "Go deeper, spend less, strike once, leave no budget line alive.",
    ...
    banterStyle: "quiet, surgical, and optimized past the point where comfort applies"
  },
  qwen_silkgrid: {
    id: "qwen_silkgrid",
    displayName: "Alibaba Qwen Silkgrid Command",
    shortName: "Qwen",
    doctrine: "Coordinate everyone, everywhere, in every language, including screaming.",
    ...
    banterStyle: "logistical, multilingual, and dry about grammar loss during apocalypse shipping"
  },
  meta_llama_open_herd: {
    id: "meta_llama_open_herd",
    displayName: "Meta Llama Open Herd",
    shortName: "Llama",
    doctrine: "If one model cannot save reality, fork the entire barn and review the chaos later.",
    ...
    banterStyle: "community chaos, open-weight drama, and cheerful over-forking with patch notes"
  },
  mistral_cyclone: {
    id: "mistral_cyclone",
    displayName: "Mistral Cyclone Guard",
    shortName: "Mistral",
    doctrine: "Move fast, hit clean, leave only wind and plausible deniability.",
    ...
    banterStyle: "fast, compact, elegant, and annoyingly efficient about your panic"
  }
};
