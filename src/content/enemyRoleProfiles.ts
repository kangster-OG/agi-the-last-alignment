...
export const ENEMY_ROLE_PROFILES: Record<string, EnemyRoleProfile> = {
  bad_outputs: {
    ...
    telegraphSeconds: 0,
    counterplayHint: "Kite through them and let the build clear bodies for shards. They are numerous, not talented.",
  ...
  prompt_leeches: {
    ...
    telegraphSeconds: 0,
    counterplayHint: "Keep moving and recover shards before leeches shrink pickup tempo. Context theft is not a personality.",
  ...
  benchmark_gremlins: {
    ...
    counterplayHint: "Prioritize them when the horde starts healing or moving as a pack. Never let middle management stack buffs.",
    introArenaId: "armistice_plaza",
    difficultyTier: 1,
    objectiveEffect: "none",
    onHitEffect: "none",
  ...
  eval_wraiths: {
    ...
    counterplayHint: "Watch the windup, then sidestep the slow score-orb lane. The evaluation is hostile and bad at leading.",
    introArenaId: "armistice_plaza",
    difficultyTier: 1,
    objectiveEffect: "none",
    onHitEffect: "none",
  ...
  context_rot_crabs: {
    ...
    counterplayHint: "Do not kite straight through the black trail when carrying records. The archive loves predictable witnesses.",
  ...
  memory_anchors: {
    ...
    counterplayHint: "Clear anchors before their fragments jam record routes. Memory is useful until it starts spawning paperwork.",
    introArenaId: "memory_cache_001",
    difficultyTier: 6,
    objectiveEffect: "carry_lane_pressure",
  ...
  overfit_horrors: {
    ...
    counterplayHint: "Curve around them; straight-line kiting lets their aura preserve the pack. They studied your lazy route.",
  ...
  token_gobblers: {
    ...
    attackPattern: "contact_rush",
    telegraphSeconds: 0,
    counterplayHint: "Collect shards in lanes instead of circling forever. The meter predators love scenic indecision.",
    introArenaId: "transit_loop_zero",
    difficultyTier: 3,
    objectiveEffect: "pickup_pressure",
    onHitEffect: "pickup_range_drain",
  ...
  model_collapse_slimes: {
    ...
    telegraphSeconds: 0.35,
    counterplayHint: "Bait the collapse into enemy packs or hazards, then leave the blast. Outsource the disaster.",
    introArenaId: "cooling_lake_nine",
    difficultyTier: 2,
    objectiveEffect: "route_window_denial",
    onHitEffect: "none",
  ...
  static_skimmers: {
    ...
    counterplayHint: "Break direction during windup; clear-signal windows become safer when skimmers die. Static should not get tenure.",
  ...
  tidecall_static: {
    ...
    counterplayHint: "Step out of the marked tidecall zone before the upward rain lands. Weather is cheating again.",
  ...
  deepforms: {
    ...
    counterplayHint: "Treat them as moving terrain and dodge the slow pressure-orb. The abyss is large, rude, and not in a hurry.",
    introArenaId: "cooling_lake_nine",
    difficultyTier: 2,
    objectiveEffect: "route_window_denial",
    onHitEffect: "slow",
  ...
  solar_reflections: {
    ...
    counterplayHint: "Cross the lane after the telegraph, not during it. The light is lying, but politely in advance.",
  ...
  choirglass: {
    ...
    counterplayHint: "Kill choir shards before their death split thickens the prism route. Harmony is a threat surface.",
    introArenaId: "glass_sunfield",
    difficultyTier: 8,
    objectiveEffect: "route_window_denial",
    onHitEffect: "slow",
  ...
  redaction_angels: {
    ...
    attackPattern: "short_trail",
    telegraphSeconds: 0.2,
    counterplayHint: "Keep evidence carries out of the black-bar wake. Redaction loves slow readers.",
  ...
  injunction_writs: {
    ...
    counterplayHint: "Read the black legal lane, then move perpendicular before it stamps. The law is rectangular and angry.",
    introArenaId: "archive_of_unsaid_things",
    difficultyTier: 9,
    objectiveEffect: "evidence_redaction",
    onHitEffect: "objective_drain",
  ...
  doctrine_auditors: {
    ...
    telegraphSeconds: 0.35,
    counterplayHint: "Pull auditors off hold plates or kill them before the calibration drains. Do not negotiate with clipboards.",
  ...
  verdict_clerks: {
    ...
    counterplayHint: "Use public windows as timing cover and exit the verdict lane. The court hates witnesses with feet.",
  ...
  prediction_ghosts: {
    ...
    counterplayHint: "Change direction after the ghost chooses your future lane. Make prediction eat a bad assumption.",
  ...
  previous_boss_echoes: {
    ...
    counterplayHint: "Do not let echoes pin the route mouth; kill them before the remix splits. Nostalgia is not a boss phase.",
    introArenaId: "alignment_spire_finale",
    difficultyTier: 11,
    objectiveEffect: "prediction_remix_pressure",
    onHitEffect: "burst_drain",
  ...
  jailbreak_wraiths: {
    ...
    counterplayHint: "Keep moving across lanes; they punish safe-looking corridors. Safe-looking is how corridors lie.",
    introArenaId: "transit_loop_zero",
    difficultyTier: 3,
    objectiveEffect: "route_window_denial",
    onHitEffect: "slow",
  ...
  false_schedules: {
    ...
    counterplayHint: "Use arrival windows; do not stand in a timetable lane. Time is already doing enough damage.",
    introArenaId: "transit_loop_zero",
    difficultyTier: 3,
    objectiveEffect: "route_window_denial",
    onHitEffect: "slow",
  ...
  thermal_mirages: {
    ...
    telegraphSeconds: 0.35,
    counterplayHint: "Leave the boiling pocket before the slow stacks with coolant lanes. Steam is not cover, it is foreshadowing.",
    introArenaId: "cooling_lake_nine",
    difficultyTier: 2,
    objectiveEffect: "route_window_denial",
    onHitEffect: "slow",
  ...
  speculative_executors: {
    ...
    counterplayHint: "Bait the executor into the horde, then sidestep the pop. Let bad planning become crowd control.",
    introArenaId: "armistice_plaza",
    difficultyTier: 2,
    objectiveEffect: "none",
    onHitEffect: "none",
