...
- Captured the camera-scale correction from playtest feedback: AGI maps should remain larger than the benchmark references, but normal combat should use a closer tactical camera crop comparable to the reference point of view. Updated `docs/GAME_DIRECTION.md`, `docs/AGI_VISUAL_ART_BIBLE.md`, `docs/ASSET_PIPELINE.md`, and `docs/VISUAL_FIDELITY_VERTICAL_SLICE.md` so future asset generation accounts for both bigger worlds and higher close-camera fidelity.
